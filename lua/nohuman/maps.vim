...
" Formas de salvar
nnoremap <silent>çç :w!<CR>
nnoremap <silent><leader>çç :w!<CR>
nnoremap <silent><C-s> :w!<CR>
inoremap <silent><C-s> :w!<CR>
vnoremap <silent><C-s> :w!<CR>

" Centralizar Pesquisa
...
nnoremap <silent><leader><CR> :call ChooseTerm("term-slider", 1)<CR>
tnoremap <silent><leader><CR> <C-\><C-n>:call ChooseTerm("term-slider", 1)<CR>
...
" Goto private config
nnoremap <silent><leader>kc :e ~/.config/nvim/arejano/init.lua<CR>
...
" Execute this file
nnoremap <leader>tj :call tj#save_and_exec()<CR>
...
nnoremap <silent> <leader>e :call ToggleNvimTree()<CR>
nnoremap <silent> <leader>n :NvimTreeFocus<CR>


" Neoformat with prettier
nnoremap <silent> <leader>; :Neoformat prettier<CR>


"Open lazygit
nnoremap <silent> <leader>lg :LazyGit<CR>

nnoremap <silent><leader>g1 <Cmd>BufferLineGoToBuffer 1<CR>
nnoremap <silent><leader>g2 <Cmd>BufferLineGoToBuffer 2<CR>
nnoremap <silent><leader>g3 <Cmd>BufferLineGoToBuffer 3<CR>
nnoremap <silent><leader>g4 <Cmd>BufferLineGoToBuffer 4<CR>
nnoremap <silent><leader>g5 <Cmd>BufferLineGoToBuffer 5<CR>
nnoremap <silent><leader>g6 <Cmd>BufferLineGoToBuffer 6<CR>
nnoremap <silent><leader>g7 <Cmd>BufferLineGoToBuffer 7<CR>
nnoremap <silent><leader>g8 <Cmd>BufferLineGoToBuffer 8<CR>
nnoremap <silent><leader>g9 <Cmd>BufferLineGoToBuffer 9<CR>
